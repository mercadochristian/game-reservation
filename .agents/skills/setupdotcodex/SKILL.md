---
name: setupdotcodex
description: Scan the project codebase and customize all .codex/ configuration files to match. Run this after adding Codex config files to a new project.
argument-hint: "[optional: focus area like 'frontend' or 'backend']"
disable-model-invocation: true
---

Scan this project's codebase and customize every `.codex/` configuration file to match the actual tech stack, conventions, and patterns in use. Confirm with the user before each change.

AGENTS.md must be at the project root (`./AGENTS.md`), NOT inside `.codex/`. All other config files live inside `.codex/`.
...
Before anything else, delete files inside `.codex/` that exist for the dotclaude repo itself but waste tokens or cause issues at runtime:
- `.codex/README.md` (repo README accidentally copied in)
- `.codex/CONTRIBUTING.md` (repo contributing guide accidentally copied in)
- `.codex/.gitignore` (for the dotclaude repo, not the project — the project has its own .gitignore)
- `.codex/rules/README.md`
- `.codex/agents/README.md`
- `.codex/hooks/README.md`
- `.codex/skills/README.md`

Also delete `.codex/AGENTS.md` if it exists — AGENTS.md belongs at the project root, not inside `.codex/`.
...
Should I customize the .codex/ files based on this? (yes/no/corrections)
```
...
Strip any remaining `> REPLACE:` placeholder blocks from `AGENTS.md` — these are template guidance that should have been replaced with real content or removed during Phase 3.1.

Review the entire codebase alongside the customized `.codex/` configuration:
...
- AGENTS.md: updated commands for [stack]
...
- Preserve any manual edits the user has already made to .codex/ files — only update sections that need project-specific customization
