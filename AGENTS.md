...
- Claude configuration remains in `.claude/`.
- Codex mirrors are in `.codex/` and `.agents/skills/`.
...
**Email/password auth** — Supabase auth via `@supabase/ssr` middleware. Users sign up with email + password, or sign in with existing credentials. See [`.codex/rules/supabase.md`](.codex/rules/supabase.md) for the full client selection decision tree.
...
- [`.codex/rules/code-quality.md`](.codex/rules/code-quality.md) — Code standards, UI conventions, forms, animations, and development mindset
- [`.codex/rules/frontend.md`](.codex/rules/frontend.md) — Design tokens (CSS custom properties), dark mode, layout standards, component composition, accessibility, and performance
- [`.codex/rules/supabase.md`](.codex/rules/supabase.md) — Client selection (createClient vs createServiceClient), RLS, result handling, auth session management
- [`.codex/rules/nextjs.md`](.codex/rules/nextjs.md) — Server vs Client Components, data fetching strategy, API route structure, middleware scope, cache behavior
- [`.codex/rules/security.md`](.codex/rules/security.md) — Input validation, authentication, secrets management, and data protection
- [`.codex/rules/testing.md`](.codex/rules/testing.md) — Testing stack, file conventions, mock helpers, unit vs integration, coverage thresholds (alwaysApply)
- [`.codex/rules/error-handling.md`](.codex/rules/error-handling.md) — Error classification, logging, promise handling, and API responses
- [`.codex/rules/database.md`](.codex/rules/database.md) — Migration safety, schema design, reversibility, and data management
- [`.codex/rules/code-review.md`](.codex/rules/code-review.md) — When to run senior-code-reviewer, what it checks, and how to act on findings
