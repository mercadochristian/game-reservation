...
export default function Dashboard() {
  ...
  const fetchRole = async () => {
    ...
    try {
      ...
      if (profileError) {
        console.error('[Dashboard] Failed to fetch user profile:', profileError)
        setErrorMessage(getUserFriendlyMessage(profileError))
        setLoading(false)
        return
      }
      ...
      setErrorMessage(getUserFriendlyMessage(err))
    } finally {
      setLoading(false)
    }
  }
