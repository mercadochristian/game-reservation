...
export default function SchedulesPage() {
  ...
  const { data: loadedSchedules, isLoading: loadingSchedules, execute: fetchSchedules } = useSupabaseQuery<ScheduleWithLocation[]>({ context: 'load schedules' })
  const { data: loadedLocations, isLoading: loadingLocations, execute: fetchLocations } = useSupabaseQuery<Location[]>({ context: 'load locations' })
  const loading = loadingSchedules || loadingLocations
