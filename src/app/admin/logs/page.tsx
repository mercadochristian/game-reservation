...
export default function ErrorLogsPage() {
  ...
  const { data: logs, isLoading: loading, execute: fetchLogs } = useSupabaseQuery<LogWithUser[]>({ context: 'load logs', showToast: false })
  ...
  }, [fetchLogs, dateFrom, dateTo, selectedLevel, supabase])

  // Load logs when page, pageSize, or filters change
  useEffect(() => {
    loadLogs(currentPage, pageSize)
  }, [currentPage, pageSize, loadLogs])
